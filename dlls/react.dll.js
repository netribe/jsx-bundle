...
module.exports = test;
    ...
    if((typeof node_modules === 'undefined') && (typeof require === 'undefined') && (typeof window !== 'undefined')){
        window.node_modules = {};
    }
    if(node_modules){
        if(typeof mod.exports === 'function'){
            ...
            console.warn('module.exports should be an object or a function. the log below is what we got:');
